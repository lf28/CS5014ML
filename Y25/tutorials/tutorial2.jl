...
* Based on your backward pass steps, explain why `residual block` usually works better than the regular `dense layer` from the gradient flow's perspective
"""
...
manifest_format = "2.0"
project_hash = "a03bdfe748cb1554519e3e714995180917c204d1"
