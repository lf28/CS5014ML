...
function cross_entropy_loss_with_gradient(w, b, X, y)
    ## compute the loss 
...
After you finish implementing all the above methods, use your learning algorithm to train a logistic regression model on the training dataset and answer the following tasks
...
function logistic_regression_reg_train(X, y, lr, lam = 0.01, tol= 1e-5, maxIters= 2000)
    # initialise w0, b0
	losses = []
    # loop until converge
    for i in 1:maxIters
...
manifest_format = "2.0"
project_hash = "0c2ca398fe6a9124baef3daa821dfbdf6b4fb41a"
