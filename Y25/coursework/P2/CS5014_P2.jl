...
# ╔═╡ 369a56ca-18f2-4cb5-8d3f-474dde34e8f1
function m_step(X, R)
	## implement here 
	return πs, μs
end
...
function em_mixberns(X, K, tol = 1e-4, maxIters = 100)
	## initilisation
...
# ╔═╡ 38173718-aac1-40b7-b31f-8418dbd4be57
em_mixberns(sim_X, 3);
...
# ╔═╡ fec90f4c-7b3c-4cef-9dff-e7542b7bce55
em_mixberns(X_mnist_train, 10);

# ╔═╡ 31b6abd0-6c1d-4d32-b4d6-ec3986559240
...
function posterior_predictive_impute(x, πs, μs)
